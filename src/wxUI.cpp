...
MainUI::MainUI(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
    ...
    btn_prev_page =
        toolbar->AddTool(wxID_UP, wxT("上一页"), wxBITMAP_PNG(IMG_PREV_PAGE), wxNullBitmap,
                         wxITEM_NORMAL, wxT("上一页"), wxT("上一页"), NULL);

    btn_next_page =
        toolbar->AddTool(wxID_DOWN, wxT("下一页"), wxBITMAP_PNG(IMG_NEXT_PAGE), wxNullBitmap,
                         wxITEM_NORMAL, wxT("下一页"), wxT("下一页"), NULL);

    toolbar->AddSeparator();

    btn_save = toolbar->AddTool(wxID_SAVE, wxT("保存"), wxBITMAP_PNG(IMG_SAVE), wxNullBitmap,
                                wxITEM_NORMAL, wxT("保存"), wxT("保存"), NULL);

    btn_load = toolbar->AddTool(wxID_OPEN, wxT("载入"), wxBITMAP_PNG(IMG_LOAD), wxNullBitmap,
                                wxITEM_NORMAL, wxT("载入"), wxT("载入"), NULL);

    toolbar->AddSeparator();

    btn_zoom_page = toolbar->AddTool(wxID_ZOOM_FIT, wxT("缩放合适大小"),
                                     wxBITMAP_PNG(IMG_ZOOM_PAGE), wxNullBitmap, wxITEM_NORMAL,
                                     wxT("缩放合适大小"), wxT("缩放合适大小"), NULL);

    btn_crop_curr_page =
        toolbar->AddTool(btnid_CROP_CURR_PAGE, wxT("裁剪当前页"), wxBITMAP_PNG(IMG_CROP_CURR_PAGE),
                         wxNullBitmap, wxITEM_NORMAL, wxT("裁剪当前页"), wxT("裁剪当前页"), NULL);

    btn_crop_all_page =
        toolbar->AddTool(btnid_CROP_ALL_PAGE, wxT("裁剪全部"), wxBITMAP_PNG(IMG_CROP_ALL_PAGE),
    ...
    pn_page_list = new wxListBox(this, pnid_PAGE_LIST, wxDefaultPosition, wxDefaultSize, 0, NULL,
                                 wxLB_NEEDED_SB);
    ...
    pn_canvas = new wxPanel(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    m_mgr.AddPane(pn_canvas, wxAuiPaneInfo()
                                 ...
                                 .FloatingSize(wxDefaultSize)
                                 .CentrePane());
    auto* bSizer31 = new wxBoxSizer(wxVERTICAL);
    ...
    pn_config = new wxNotebook(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, wxT("设置"));
    ...
    ntbk_cfg_process =
        new wxPanel(pn_config, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer* bSizer4;
    bSizer4 = new wxBoxSizer(wxVERTICAL);

    sld_cfg_pix_filter =
        new SliderWithSpin(ntbk_cfg_process, sldid_cfg_PIX_FILTER, wxT("忽略斑点直径"), 8, 0, 50);
    ...
    sld_cfg_border =
        new SliderWithSpin(ntbk_cfg_output, sldid_cfg_BORDER, wxT("空白边距"), 10, 0, 100);
